...
Latest: **v0.6.1 — "Carve"** (a task that forbids tools gets printed instead of sent, and CALLER_SLOT never survived the Bash call that set it — both silent, both measured)
